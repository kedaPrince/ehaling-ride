...
import com.example.hdriver.Model.DriverInfoModel;
...
public class Common {
    ...
    public static void showNotification(Context context, int id, String title, String body, Intent intent) {
        ...
        String NOTIFICATION_CHANNEL_ID = "ha_driver_remake";
        NotificationManager notificationManager = (NotificationManager)context.getSystemService(Context.NOTIFICATION_SERVICE);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID,
                    "HaDriver Remake", NotificationManager.IMPORTANCE_HIGH);
            notificationChannel.setDescription("HaDriver Remake");
    ...
    public static String createUniqueIdNumber(long timeOffset) {
