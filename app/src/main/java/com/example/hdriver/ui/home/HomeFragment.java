package com.example.hdriver.ui.home;
...
import com.example.hdriver.Model.RiderModel;
import com.example.hdriver.Model.TripPlanModel;
import com.example.hdriver.R;
import com.example.hdriver.Remote.IGoogleAPI;
import com.example.hdriver.Remote.RetrofitClient;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback {
    ...
    @BindView(R.id.txt_start_uber_estimate_distancce)
    TextView txt_start_uber_estimate_distancce;
    ...
    void onDeclineClick() {
        if (driverRequestReceived != null) {
            ...
            {
                //come back and enter permission
            ...
            compositeDisposable.add(iGoogleAPI.getDirections("driving",
                    ...
                    .subscribe(returnResult ->{
                        ...
                        try {
                            ...
                            valueAnimator.setDuration(1100); //check again might have to be setDuration
        ...
        pickupGeoFire.setLocation(key, new GeoLocation(destination.latitude, destination.longitude),
                (key1, error) -> {
                    ...
                    if (error !=null)
                        ...
                        Log.d("HaDriver", key1 +"was created succcessfully on geo Fire");
                });
    }
                                        ...
                                        if (dataSnapshot.exists()) {
                                            ...
                                            fusedLocationProviderClient.getLastLocation()
                                                    ...
                                                    .addOnSuccessListener(location -> {
                                                        ...
                                                        tripNumberId = Common.createUniqueIdNumber(timeOffset);
                                                        ...
                                                        FirebaseDatabase.getInstance()
                                                            ...
                                                            txt_start_uber_estimate_distancce.setText(distance);
